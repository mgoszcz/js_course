  ...
  _hideForm() {
    inputDistance.value =
      ...
      inputElevation.value =
        '';
    // Just simple adding hidden class will trigger animation of hiding form and moving workouts on list up
    // We want to avoid it and have it look like new workout element replaces form without animation
    // to do it we need to hide form immeditaely, add hidden class then and after 1 second (when animation finishes)
    // we need to set display to previous value
